...
@router.post("/register", response_model=DoctorOut, status_code=201, summary="Регистрация врача")
...
@router.get("/me", response_model=DoctorOut, summary="Текущий пользователь")

...
@router.get("", response_model=list[PatientOut], summary="Список пациентов врача")
...
@router.post("", response_model=PatientOut, status_code=status.HTTP_201_CREATED, summary="Создать карточку пациента")
...
@router.get("/{patient_id}", response_model=PatientOut, summary="Получить карточку пациента")
...
@router.patch("/{patient_id}", response_model=PatientOut, summary="Изменить карточку пациента")
...
@router.delete("/{patient_id}", status_code=status.HTTP_204_NO_CONTENT, summary="Удалить карточку пациента")
